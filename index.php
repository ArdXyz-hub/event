            ...
            <div class="mobile">
                ...
                <div class="scroll" id="skin">
                    <div class="row px-3 mt-2">
                        <div class="col-md-4 col-4 d-inline mx-auto">
                            <div class="reward-box">
                                <img src="static/img/kof/1.png" class="d-block mx-auto" alt="">
                                <button class="btn btn-sm btn-danger d-block mx-auto"><i class="zmdi zmdi-card-giftcard mr-1"></i> CLAIM</button>
                            </div>
                        </div>
                        <div class="col-md-4 col-4 d-inline mx-auto">
                            <div class="reward-box">
                                <img src="static/img/kof/baru.png" class="d-block mx-auto" alt="">
                                <button class="btn btn-sm btn-danger d-block mx-auto"><i class="zmdi zmdi-card-giftcard mr-1"></i> CLAIM</button>
                            </div>
                        </div>
                        <div class="col-md-4 col-4 d-inline mx-auto">
                            <div class="reward-box">
                                <img src="static/img/kof/3.png" class="d-block mx-auto" alt="">
                                <button class="btn btn-sm btn-danger d-block mx-auto"><i class="zmdi zmdi-card-giftcard mr-1"></i> CLAIM</button>
                            </div>
                        </div>
                    </div>
                    <div class="row px-3 mt-2">
                        <div class="col-md-4 col-4 d-inline mx-auto">
                            <div class="reward-box">
                                <img src="static/img/kof/4.png" class="d-block mx-auto" alt="">
                                <button class="btn btn-sm btn-danger d-block mx-auto"><i class="zmdi zmdi-card-giftcard mr-1"></i> CLAIM</button>
                            </div>
                        </div>
                        <div class="col-md-4 col-4 d-inline mx-auto">
                            <div class="reward-box">
                                <img src="static/img/kof/5.png" class="d-block mx-auto" alt="">
                                <button class="btn btn-sm btn-danger d-block mx-auto"><i class="zmdi zmdi-card-giftcard mr-1"></i> CLAIM</button>
                            </div>
                        </div>
                        <div class="col-md-4 col-4 d-inline mx-auto">
                            <div class="reward-box">
                                <img src="static/img/kof/6.png" class="d-block mx-auto" alt="">
                                <button class="btn btn-sm btn-danger d-block mx-auto"><i class="zmdi zmdi-card-giftcard mr-1"></i> CLAIM</button>
                            </div>
                        </div>
                    </div>
                    <div class="row px-3 mt-2">
                        <div class="col-md-4 col-4 d-inline mx-auto">
                            <div class="reward-box">
                                <img src="static/img/skins/1.jpeg" class="d-block mx-auto" alt="">
                                <button class="btn btn-sm btn-danger d-block mx-auto"><i class="zmdi zmdi-card-giftcard mr-1"></i> CLAIM</button>
                            </div>
                        </div>
                        <div class="col-md-4 col-4 d-inline mx-auto">
                        ...
                        <div class="col-md-4 col-4 d-inline mx-auto">
                            <div class="reward-box">
                                <img src="static/img/skins/3.jpeg" class="d-block mx-auto" alt="">
                                <button class="btn btn-sm btn-danger d-block mx-auto"><i class="zmdi zmdi-card-giftcard mr-1"></i> CLAIM</button>
                            </div>
                        </div>
                    </div>
                    <div class="row px-3 mt-3">
                        ...
                        <div class="col-md-4 col-4 d-inline mx-auto">
                            <div class="reward-box">
                                <img src="static/img/skins/5.jpeg" class="d-block mx-auto" alt="">
                                <button class="btn btn-sm btn-danger d-block mx-auto"><i class="zmdi zmdi-card-giftcard mr-1"></i> CLAIM</button>
                            </div>
                        </div>
                        <div class="col-md-4 col-4 d-inline mx-auto">
                    ...
                    <div class="row px-3 mt-2">
                        <div class="col-md-4 col-4 d-inline mx-auto">
                            <div class="reward-box">
                                <img src="static/img/new/1.jpeg" class="d-block mx-auto" alt="">
                                <button class="btn btn-sm btn-danger d-block mx-auto"><i class="zmdi zmdi-card-giftcard mr-1"></i> CLAIM</button>
                            </div>
                        </div>
                        <div class="col-md-4 col-4 d-inline mx-auto">
                            <div class="reward-box">
                                <img src="static/img/new/2.jpeg" class="d-block mx-auto" alt="">
                                <button class="btn btn-sm btn-danger d-block mx-auto"><i class="zmdi zmdi-card-giftcard mr-1"></i> CLAIM</button>
                            </div>
                        </div>
                        <div class="col-md-4 col-4 d-inline mx-auto">
                            <div class="reward-box">
                                <img src="static/img/new/3.jpeg" class="d-block mx-auto" alt="">
                                <button class="btn btn-sm btn-danger d-block mx-auto"><i class="zmdi zmdi-card-giftcard mr-1"></i> CLAIM</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row px-3 mt-3">
                        <div class="col-md-4 col-4 d-inline mx-auto">
                            <div class="reward-box">
                                <img src="static/img/skins/7.jpeg" class="d-block mx-auto" alt="">
                                <button class="btn btn-sm btn-danger d-block mx-auto"><i class="zmdi zmdi-card-giftcard mr-1"></i> CLAIM</button>
                            </div>
                        </div>
                        <div class="col-md-4 col-4 d-inline mx-auto">
                        ...
                        <div class="col-md-4 col-4 d-inline mx-auto">
                            <div class="reward-box">
                                <img src="static/img/skins/9.jpeg" class="d-block mx-auto" alt="">
                                <button class="btn btn-sm btn-danger d-block mx-auto"><i class="zmdi zmdi-card-giftcard mr-1"></i> CLAIM</button>
                            </div>
                        </div>
                    </div>
